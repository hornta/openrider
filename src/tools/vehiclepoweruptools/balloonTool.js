...
const BalloonTool = function (obj, target) {
	this.toolInit(target);
	this.powerup = new Balloon(0, 0, 0, target.scene.track);
	this.p1 = new Vector2(0, 0);
	this.p2 = new Vector2(0, 0);
	this.options = obj.options;
	this.active = false;
};
BalloonTool.prototype = new Tool();
const self = BalloonTool.prototype;
...
self.release = function () {
	...
	const o = new Balloon(this.p1.x, this.p1.y, this.options.time, t);
	t.addPowerup(o);
	this.active = false;
