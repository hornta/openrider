...
const CheckpointTool = function (data) {
	this.toolInit(data);
	this.powerup = new Checkpoint(0, 0, data.scene.track);
	this.p1 = new Vector2(0, 0);
	this.p2 = new Vector2(0, 0);
	this.active = false;
};
CheckpointTool.prototype = new Tool();
const self = CheckpointTool.prototype;
...
self.release = function () {
	...
	const val = new Checkpoint(this.p1.x, this.p1.y, ctx);
	ctx.addPowerup(val);
	this.active = false;
